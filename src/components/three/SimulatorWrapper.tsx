    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a2e] to-[#12121f] flex items-center justify-center p-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-gray-400 leading-relaxed mb-8">
          De 3D Balustrade Configurator is beschikbaar op desktop en tablet (landscape).
          Open deze pagina op een groter scherm voor de beste ervaring.
        </p>
...
export default function SimulatorWrapper() {
  ...
  useEffect(() => {
    const check = () => {
      // Block on screens narrower than 900px (phones + small tablets portrait)
