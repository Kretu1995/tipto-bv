        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="text-center p-6 rounded-sm bg-off-white border border-gray-100"
            >
              <div className="text-3xl mb-3">{stat.icon}</div>
              <div className="text-2xl font-bold text-gold font-[family-name:var(--font-playfair)] mb-2">
                {stat.value}
              </div>
